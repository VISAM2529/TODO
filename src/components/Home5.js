      ...
      <div className="App  h-fit  flex items-center justify-center">
        ...
        <div className=" max-w-lg flex  flex-col items-center gap-0 mb-5">
          <div className="flex gap-5 px-10 py-10">
            <input
              ref={inputref}
              className=" border-x-4 border-y-4 border-gray-300 bg-gray-300 text-2xl w-80 py-2 px-5 rounded-full"
            ...
            {data.map((item) => {
              return (
                <div className="flex items-center justify-center gap-28 bg-white py-4 px-3 shadow-2xl rounded-lg">
                  <div>
                    <h1 className=" text-center  flex gap-10 items-center text-2xl">
                      <FiEdit
                        onClick={() => edit(item)}
                  ...
                  <h1 className="flex gap-10 text-center text-3xl">
                    <FcOk
